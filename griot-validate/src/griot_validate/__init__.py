"""
Griot Validate - Runtime Validation for Data Orchestrators
...
from griot_validate.validator import (
...
def __getattr__(name: str) -> object:
    ...
    if name == "airflow":
        from griot_validate import airflow
        return airflow
    if name == "dagster":
        from griot_validate import dagster
        return dagster
    if name == "prefect":
        from griot_validate import prefect
        return prefect
