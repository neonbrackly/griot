...
import { Step2Tables } from '@/components/assets/wizard/Step2Tables'
import { Step3Configure } from '@/components/assets/wizard/Step3Configure'
import { Step4Review } from '@/components/assets/wizard/Step4Review'
...
export default function CreateAssetPage() {
  ...
  const updateFormData = React.useCallback((data: Partial<AssetFormData>) => {
  ...
  return (
    <PageContainer>
      <div className="max-w-4xl mx-auto">
        <BackLink href="/studio/assets" label="All Assets" className="mb-6" />
