...
>(({ className, children, error, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-9 w-full items-center justify-between rounded-lg border border-border-default bg-bg-primary px-3 py-2 text-sm',
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-popover max-h-96 min-w-[8rem] overflow-hidden rounded-lg border border-border-default bg-bg-secondary shadow-lg',
