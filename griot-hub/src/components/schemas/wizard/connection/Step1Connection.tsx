...
import { Plus, Check, AlertCircle, Database as DatabaseIcon, Server } from 'lucide-react'
...
import type { ConnectionSchemaFormData, Connection } from '@/types'
...
function ConnectionCard({
  ...
  const lastTestedRecently = connection.lastTestedAt &&
    (new Date().getTime() - new Date(connection.lastTestedAt).getTime()) < 3600000
