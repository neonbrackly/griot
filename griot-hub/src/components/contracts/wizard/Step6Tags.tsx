  ...
  return (
    <div className="space-y-6">
      ...
      <FormField
        name="ownerTeam"
        label="Owner Team"
        description="Optional - assign a team to own this contract"
      >
        <select
          className="w-full px-3 py-2 border border-border-default rounded-md bg-bg-primary text-text-primary focus:outline-none focus:ring-2 focus:ring-primary-500"
          value={formData.ownerTeamId || ''}
          onChange={(e) => updateFormData({ ownerTeamId: e.target.value || undefined })}
        >
