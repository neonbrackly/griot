...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-dropdown min-w-[8rem] overflow-hidden rounded-lg border border-border-default bg-bg-secondary p-1 shadow-lg',
...
>(({ className, inset, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive && 'text-error-text focus:bg-error-bg focus:text-error-text',
      inset && 'pl-8',
      className
    )}
    {...props}
